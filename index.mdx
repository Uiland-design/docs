...
<Card
  ...
  horizontal
>
  Follow the three-step quickstart guide.
</Card>
...
<Columns cols={2}>
  ...
  >
    Customize the design and colors to match your brand.
  </Card>
  <Card
  ...
  >
    Organize your docs to help users find what they need.
  </Card>
  <Card
...
Build docs that work for humans and AI agents alike.
...
>
  Browse the showcase of exceptional documentation sites.
</Card>
